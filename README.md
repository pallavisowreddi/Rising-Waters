...
- **Pravallika Relli** (Team Lead):
  - Overall project coordination, requirement specification, solution architecture layout, and project demonstration planning.
- **Pallavi Sowreddi** (Member):
  - Handled data preprocessing, StandardScaler fitting, pure Python decision tree compilation, Flask API route handlers, and local web app routing.
- **Niha Niha** (Member):
  - Developed the analytical data plotting pipeline (`visualize.py`), UI design aesthetics, performance testing validations, and final reports documentation.
